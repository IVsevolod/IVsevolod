...
$this->registerJsFile(Yii::$app->request->baseUrl . '/js/tree/add.js', ['depends' => [\yii\web\JqueryAsset::className()]]);

$this->title = 'Добавление ветки';
    ...
    <div class="row">
        <div class="col-lg-9">
            ...
            <div class="input-group margin-bottom">
                ...
                <?= Html::textInput('parent', '', array('id' => 'tokenfield', 'data-tokens' => '', 'class' => 'form-control')) ?>
            </div>
